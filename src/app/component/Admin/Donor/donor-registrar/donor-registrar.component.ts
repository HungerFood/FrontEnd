...
@Component({
  selector: 'app-donor-registrar',
  templateUrl: './donor-registrar.component.html',
  styleUrl: './donor-registrar.component.css'
})
export class DonorRegistrarComponent implements OnInit{
